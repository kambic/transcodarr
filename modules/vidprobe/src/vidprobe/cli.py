...
from vidprobe.bench import BenchTask, run_bench
from vidprobe.compare import compare as build_comparison
from vidprobe.config import (
    SAMPLE_CONFIG,
    Build,
    ConfigError,
    LanguagePolicy,
...
from vidprobe.quality import ALL_METRICS, measure, vmaf_available
from vidprobe.render import (
    _kv_table,
    alignment_panel,
    bench_table,
    builds_table,
...
from vidprobe.streams import Decision, Plan, list_streams, plan_audio, plan_languages
from vidprobe.thumbs import ThumbMode, generate_sprite, generate_thumbnails, media_geometry
...
def monitor(
    ...
    from vidprobe.monitor import monitor as run_monitor
...
def config_path(ctx: typer.Context) -> None:
    ...
    from vidprobe.config import candidate_paths
